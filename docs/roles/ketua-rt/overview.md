...
![RT Home Screen](../../assets/ketua-rt-home-screen.jpg)
...
<div className="feature-grid">
  <div className="feature-card">
    ...
    <div className="feature-card-title">Total Warga</div>
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Status Iuran</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Laporan Aktif</div>
    <div className="feature-card-description">
...
<div className="feature-grid">
  <div className="feature-card">
    ...
    <div className="feature-card-title">Data Warga</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Tambah Warga</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Data Keluarga</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Wilayah RT</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Catat Mutasi</div>
    <div className="feature-card-description">
...
<div className="feature-grid">
  <div className="feature-card">
    <div className="feature-card-icon" style={{backgroundColor: 'rgba(233, 30, 99, 0.1)', color: '#E91E63'}}>
      📅
    </div>
    <div className="feature-card-title">Kegiatan RT</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    <div className="feature-card-icon" style={{backgroundColor: 'rgba(103, 58, 183, 0.1)', color: '#673AB7'}}>
      🤝
    </div>
    <div className="feature-card-title">Rapat RT</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Pengumuman</div>
    <div className="feature-card-description">
...
<div className="feature-grid">
  <div className="feature-card">
    ...
    <div className="feature-card-title">Pengajuan Surat</div>
    <div className="feature-card-description">
  ...
  <div className="feature-card">
    ...
    <div className="feature-card-title">Laporan RT</div>
    <div className="feature-card-description">
